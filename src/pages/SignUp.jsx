...
const SignUp = () => {
  ...
  return (
    <>
      <section className="bg-[#F4F7FF] py-10 lg:py-[50px] h-screen">
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4">
              <div
                className="relative mx-auto w-[40%] overflow-hidden rounded-lg bg-white py-8 px-10  sm:px-12 md:px-[60px]"
              >
                  ...
                  <div className="mb-2">
                    ...
                    />
                    {
                      formik.touched.confirm_password && formik.errors.confirm_password ? 
                        <div className="mt-2 text-xs text-red-600 dark:text-red-400">{formik.errors.confirm_password}</div> : null
                    }
                  </div>
                  <div className="mb-10">
                    <button
                ...
                <p className="text-base text-[#adadad] text-center">
